...
- (void)sUserBalanceAddBankSuccess:(SUserBalanceAddBankSuccessBlock)success andFailure:(SUserBalanceAddBankFailureBlock)failure {
    [HttpManager postWithUrl:@"UserBalance/addBank" baseurl:Base_url  andParameters:@{@"name":_name,@"bank_type_id":_bank_type_id,@"open_bank":_open_bank,@"card_number":_card_number,@"phone":_phone} andSuccess:^(id Json) {
