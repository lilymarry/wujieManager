...
- (void)sUserBalanceEditBankSuccess:(SUserBalanceEditBankSuccessBlock)success andFailure:(SUserBalanceEditBankFailureBlock)failure {
    [HttpManager postWithUrl:@"UserBalance/editBank" baseurl:Base_url andParameters:@{@"bank_card_id":_bank_card_id,@"name":_name,@"bank_type_id":_bank_type_id,@"open_bank":_open_bank,@"card_number":_card_number,@"phone":_phone} andSuccess:^(id Json) {
