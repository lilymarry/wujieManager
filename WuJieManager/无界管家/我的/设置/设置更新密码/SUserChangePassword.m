...
- (void)sUserChangePasswordSuccess:(SUserChangePasswordSuccessBlock)success andFailure:(SUserChangePasswordFailureBlock)failure {
    [HttpManager postWithUrl:@"User/changePassword"  baseurl:Base_url andParameters:@{@"oldPassword":_oldPassword,@"newPassword":_thisNewPassword,@"rePassword":_rePassword} andSuccess:^(id Json) {
