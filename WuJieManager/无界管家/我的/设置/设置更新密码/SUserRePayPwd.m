...
- (void)sUserRePayPwdSuccess:(SUserRePayPwdSuccessBlock)success andFailure:(SUserRePayPwdFailureBlock)failure {
    [HttpManager postWithUrl:@"User/rePayPwd" baseurl:Base_url andParameters:@{@"oldPayPwd":_oldPayPwd,@"newPayPwd":_thisNewPayPwd,@"rePayPwd":_rePayPwd} andSuccess:^(id Json) {
