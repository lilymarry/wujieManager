...
- (void)sRegisterOtherLoginSuccess:(SRegisterOtherLoginSuccessBlock)success andFailure:(SRegisterOtherLoginFailureBlock)failure {
    [HttpManager postUploadSingleImageWithUrl:@"Register/otherLogin"
     baseurl:Base_url 
                                 andImageName:_head_pic andKeyName:@"head_pic" andParameters:@{@"openid":_openid,@"type":_type,@"nickname":_nickname} andSuccess:^(id Json) {
