...
- (void)sRegisterOtherLoginBindSuccess:(SRegisterOtherLoginBindSuccessBlock)success andFailure:(SRegisterOtherLoginBindFailureBlock)failure {
    [HttpManager postWithUrl:@"Register/otherLoginBind" baseurl:Base_url andParameters:@{@"bind_id":_bind_id,@"phone":_phone,@"verify":_verify,@"invite_code":_invite_code} andSuccess:^(id Json) {
