...
- (void)sRegisterRegisterSuccess:(SRegisterRegisterSuccessBlock)success andFailure:(SRegisterRegisterFailureBlock)failure {
    [HttpManager postWithUrl:@"Register/register" baseurl:Base_url  andParameters:@{@"phone":_phone,@"password":_password,@"confirmPassword":_confirmPassword,@"invite_code":_invite_code} andSuccess:^(id Json) {
